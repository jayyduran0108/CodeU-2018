...
public class PersistentDataStore {
  ...
  public List<User> loadUsers() throws PersistentDataStoreException {
    ...
    for (Entity entity : results.asIterable()) {
      try {
        ...
        User user = new User(uuid, userName, passwordHash, creationTime, biography);
        users.add(user);
      } catch (Exception e) {
  ...
  public List<Hashtag> loadHashtags() throws PersistentDataStoreException {
    ...
    for (Entity entity : results.asIterable()) {
      try {
        UUID uuid = UUID.fromString((String) entity.getProperty("uuid"));
        UUID posterUuid = UUID.fromString((String) entity.getProperty("poster_uuid"));
  ...
  public void writeThrough(User user) {
    ...
    userEntity.setProperty("biography", user.getBiography().toString());
