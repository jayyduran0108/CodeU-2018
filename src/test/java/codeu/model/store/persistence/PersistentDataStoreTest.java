...
public class PersistentDataStoreTest {
  ...
  public void testSaveAndLoadUsers() throws PersistentDataStoreException {
    ...
    String biographyOne = "";
    User inputUserOne = new User(idOne, nameOne, passwordHashOne, creationOne, biographyOne);
    ...
    String biographyTwo = "";
    User inputUserTwo = new User(idTwo, nameTwo, passwordHashTwo, creationTwo, biographyTwo);
    ...
    Assert.assertEquals(biographyOne, resultUserOne.getBiography());
    ...
    Assert.assertEquals(biographyTwo, resultUserTwo.getBiography());
  }
